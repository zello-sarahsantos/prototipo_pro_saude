...
const calcularReembolso = (valorPlano, teto = regrasProSaude.tetoFamiliar) => {
...
const dependentes = [
  ...
  },
  {
    ...
    valor: 450,
    status: "alerta",
    alerta: "Pendência documental: Aguardando envio de comprovante de matrícula do semestre atual."
  },
  {
    id: "d4",
    nome: "Marcos Lima",
...
const servidoresList = [
  { matricula: "12345", nome: "João da Silva", cargo: "Analista de Trânsito", plano: "Bradesco", associacao: "—", dependentes: 3, valorPlano: 3190, valorAuxilio: calcularReembolso(3190), status: "ativo" },
  { matricula: "23456", nome: "Maria Oliveira", cargo: "Técnico de Trânsito", plano: "SulAmérica", associacao: "Assefaz", dependentes: 1, valorPlano: 1800, valorAuxilio: calcularReembolso(1800), status: "ativo" },
  { matricula: "34567", nome: "Carlos Pereira", cargo: "Agente de Trânsito", plano: "Amil", associacao: "Assetran", dependentes: 0, valorPlano: 900, valorAuxilio: calcularReembolso(900), status: "pendente" },
  { matricula: "45678", nome: "Fernanda Lima", cargo: "Analista de Trânsito", plano: "Bradesco", associacao: "—", dependentes: 3, valorPlano: 5120, valorAuxilio: calcularReembolso(5120), status: "alerta" },
  { matricula: "56789", nome: "Roberto Santos", cargo: "Pensionista Temporário", plano: "CASSI", associacao: "Assetran", dependentes: 1, valorPlano: 1100, valorAuxilio: calcularReembolso(1100), status: "inativo" },
  { matricula: "67890", nome: "Patrícia Costa", cargo: "Pensionista Vitalício", plano: "SulAmérica", associacao: "Assefaz", dependentes: 2, valorPlano: 2500, valorAuxilio: calcularReembolso(2500), status: "ativo" }
];
const formatCurrency = (v) => {
  if (v === void 0 || v === null) return "R$ 0,00";
  return v.toLocaleString("pt-BR", { style: "currency", currency: "BRL" });
};
const baseImportadaGerdab = [
  {
    cpf: "123.456.789-00",
    matricula: "12345678",
    nome: "João da Silva",
    ...
    valorTitular: 1200,
    dependentes: [
      { nome: "Ana da Silva", parentesco: "Cônjuge", valor: 890 },
      { nome: "Pedro da Silva", parentesco: "Filho(a) menor de 21 anos", valor: 450 }
    ]
  },
  {
    cpf: "234.567.890-11",
...
export {
  requerimentos as a,
  baseImportadaGerdab as b,
  calcularReembolso as c,
  dependentes as d,
  servidoresList as e,
  formatCurrency as f,
  statusLabels as g,
